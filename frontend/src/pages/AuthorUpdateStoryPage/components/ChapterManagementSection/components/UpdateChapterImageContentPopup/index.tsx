...
import { UpdateChapterImageContentPopupProps } from './UpdateChapterImageContentPopup.type';
import ContentSection from './components/ContentSection';

function UpdateChapterImageContentPopup(
  props: UpdateChapterImageContentPopupProps
) {
...
export default UpdateChapterImageContentPopup;
