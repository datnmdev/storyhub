      ...
      <div className="grow flex justify-between space-x-4 overflow-hidden">
        ...
        <div className="grow flex flex-col justify-between overflow-hidden">
          ...
          <div className="grow space-x-1">
            <span>
              {t(
                'reader.rankPage.topViewSection.topStoryList.item.viewCount.label'
              )}
            </span>
            <span className="font-[450] whitespace-break-spaces">
              {t(
                'reader.rankPage.topViewSection.topStoryList.item.viewCount.content',
                {
